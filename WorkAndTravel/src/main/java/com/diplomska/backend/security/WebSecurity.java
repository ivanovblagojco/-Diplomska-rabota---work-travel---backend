...
import static com.diplomska.backend.security.SecurityConstants.ADMIN_CREATE_USER;
import static com.diplomska.backend.security.SecurityConstants.LOGIN_URL;
...
public class WebSecurity extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable().authorizeRequests()
                .antMatchers( ADMIN_CREATE_USER, LOGIN_URL)
                .permitAll()
